...
export declare type studentAccountModule = modStudBarcode | modStudVieScol | modStudVDC | modStudNotes | modStudCloud | modStudMessagerie | modStudEDT | modStudDocs | modStudCahierTexte | modStudQCM | modStudReservations | modStudCorrespondance | modStudEsidoc | modStudEdunao | modStudCater | modStudArd | modStudPearltrees | modStudEdumalin | modStudStage | modStudClickNPlay | modStudVoltaire | modStudOnisep | modStudAvenria | modStudSacoche | modStudEtudiant | modStudIjbox | modSitFinanc;

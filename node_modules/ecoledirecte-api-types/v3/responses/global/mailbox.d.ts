...
export declare type mailboxRes = mailboxResSuccess | failureRes;
export declare type mailboxResSuccess = {
    code: 200;
    token: string;
    host: string;
    data: {
...
export declare type mailboxResMessage = {
    id: number;
    mtype: "received" | "sent";
    read: boolean;
    idDossier: number;
...
export declare type messageResSuccess = {
    code: 200;
    token: string;
    host: string;
    data: {
